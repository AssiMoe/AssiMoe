...
public class MainActivity extends Activity {
    ...
    private static final int BLUE_TEXT = 0xFF183B6B;
    ...
    private View buildUi() {
        ...
        TextView foot = text(
                "Private Testversion • LibreLinkUp-Schnittstelle inoffiziell • Für Therapieentscheidungen weiterhin die offizielle Libre-App verwenden.",
                11,
                false,
                0xFF6E7F95
        );
    ...
    private View buildHeader() {
        ...
        TextView title = text("LibreMirror", 28, true, 0xFF071B3E);
        titles.addView(title);

        TextView sub = text("LibreLinkUp  →  Handy  →  Smartwatch", 14, false, 0xFF5D7596);
        titles.addView(sub, wrapTop(2));

        row.addView(titles, new LinearLayout.LayoutParams(0, LinearLayout.LayoutParams.WRAP_CONTENT, 1f));

        TextView menu = text("⋮", 30, false, 0xFF526A8A);
    ...
    private View buildGlucoseCard() {
        ...
        TextView overline = text("GLUKOSE (LIBRELINKUP)", 12, true, 0xFF58759A);
        ...
        trendLabelView = text("Stabil", 14, true, GREEN);
    ...
    private View buildLoginCard() {
        ...
        LinearLayout header = sectionHeader(
                ...
                "LibreLinkUp Login",
                "Mit deinem LibreLinkUp-Konto verbinden.",
                chevron
        );
        card.addView(header);
        ...
        TextView passLabel = text("Passwort", 11, true, 0xFF5B7190);
        passwordWrap.addView(passLabel);
        ...
        TextView regionLabel = text("Region", 11, true, 0xFF5B7190);
        regionBox.addView(regionLabel);
    ...
    private View buildActionArea() {
        ...
        startButton.setText("▶   Live-Anzeige starten");
    ...
    private void saveAndStart() {
        ...
        try {
            ...
            startButton.setText("●   Live-Anzeige läuft");
    ...
    private void renderLastReading() {
        ...
        if (!value.isEmpty()) {
            ...
            connectionChip.setText(ok ? "●  Verbunden" : "●  Letzter Wert");
        ...
        startButton.setText(enabled ? "●   Live-Anzeige läuft" : "▶   Live-Anzeige starten");
    }
